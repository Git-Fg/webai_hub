  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: theme.primaryActionButtonColor,
      ),
        ...
        data: (presets) {
          ...
          return ReorderableListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final allMetadata = ref.watch(providerMetadataProvider);
              final providerName = allMetadata.values
                  .firstWhere(
              ...
              return ListTile(
                ...
                leading: Icon(
                  ...
                  color: theme.primaryActionButtonColor,
                ),
  ...
  Future<void> _editPreset(BuildContext context, PresetData preset) async {
    ...
    if (!isGroup) {
      ...
      initialProviderType = ProviderType.values.firstWhere(
        (pt) => allMetadata[pt]!.id == providerId,
              ...
              builder: (context, ref, _) {
                return ValueListenableBuilder<ProviderType>(
                  ...
                  builder: (context, currentProviderType, _) {
                    final allMetadata = ref.read(providerMetadataProvider);
                    final currentProvider = allMetadata[currentProviderType];
                            ...
                            if (!isGroup) ...[
                              ...
                              DropdownButtonFormField<ProviderType>(
                                ...
                                items: ProviderType.values
                                    .map((providerType) {
                                      final allMetadata = ref.read(
                                        providerMetadataProvider,
                                      );
                                      final metadata =
                                          allMetadata[providerType];
                                      if (metadata == null) {
                                        return null;
                                      }
                                    ...
                                    .whereType<DropdownMenuItem<ProviderType>>()
                                    .toList(),
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            if (!isGroup) {
                              ...
                              if (configurableSettings.contains('topP')) {
                                settings['topP'] =
                                    double.tryParse(topPController.text) ??
                                    0.95;
                              }
                              if (configurableSettings.contains(
                                'useWebSearch',
                            ...
                            if (!isGroup) {
                              ...
                              result['providerId'] =
                                  allMetadata[selectedProviderType.value]!.id;
                            }
