...
class HubThemeExtension extends ThemeExtension<HubThemeExtension> {
  const HubThemeExtension({
    ...
    this.webViewProgressIndicatorColor,

    // Additional UI Colors
    this.secondaryNeutralButtonColor,
    this.shadowColor,
  ...
  final Color? drawerHeaderIconColor;
  ...
  final Color? webViewProgressIndicatorColor;

  // ============================================================================
  // Additional UI Properties
  // ============================================================================

  final Color? secondaryNeutralButtonColor;
  ...
  static const light = HubThemeExtension(
    ...
    // WebView
    webViewAppBarColor: Color(0xFF43A047), // Colors.green.shade600
    webViewProgressIndicatorColor: Color(0xFFC8E6C9), // Colors.green.shade200
    // Additional UI
    secondaryNeutralButtonColor: Color(0xFF607D8B), // Colors.blueGrey
    shadowColor: Color(0x1A000000), // Colors.black.withValues(alpha: 0.1)
    helperTextColor: Color(0xFF9E9E9E), // Colors.grey.shade500
  );
  ...
  static const dark = HubThemeExtension(
    ...
    tabBarSelectedColor: Color(
      0xFF42A5F5,
    ), // Colors.blue.shade400 (lighter for dark mode)
    ...
    // WebView - Dark Mode
    webViewAppBarColor: Color(0xFF388E3C), // Darker green for dark mode
    webViewProgressIndicatorColor: Color(
      0xFF66BB6A,
    ), // Lighter green for dark mode
    // Additional UI - Dark Mode
    secondaryNeutralButtonColor: Color(
      0xFF78909C,
    ), // Lighter blueGrey for dark mode
    shadowColor: Color(0x33000000), // Darker shadow for dark mode
    helperTextColor: Color(0xFFBDBDBD), // Lighter grey for dark mode
  );
  ...
  HubThemeExtension copyWith({
    ...
    Color? webViewProgressIndicatorColor,
    Color? secondaryNeutralButtonColor,
    Color? shadowColor,
    Color? helperTextColor,
  }) {
    return HubThemeExtension(
      incomingBubbleDecoration:
          incomingBubbleDecoration ?? this.incomingBubbleDecoration,
      outgoingBubbleDecoration:
          outgoingBubbleDecoration ?? this.outgoingBubbleDecoration,
      ...
      incomingBubbleTextStyle:
          incomingBubbleTextStyle ?? this.incomingBubbleTextStyle,
      outgoingBubbleTextStyle:
          outgoingBubbleTextStyle ?? this.outgoingBubbleTextStyle,
      incomingBubbleAvatarColor:
          incomingBubbleAvatarColor ?? this.incomingBubbleAvatarColor,
      outgoingBubbleAvatarColor:
          outgoingBubbleAvatarColor ?? this.outgoingBubbleAvatarColor,
      incomingBubbleIconColor:
          incomingBubbleIconColor ?? this.incomingBubbleIconColor,
      outgoingBubbleIconColor:
          outgoingBubbleIconColor ?? this.outgoingBubbleIconColor,
      ...
      primaryActionButtonColor:
          primaryActionButtonColor ?? this.primaryActionButtonColor,
      secondaryActionButtonColor:
          secondaryActionButtonColor ?? this.secondaryActionButtonColor,
      successActionButtonColor:
          successActionButtonColor ?? this.successActionButtonColor,
      warningActionButtonColor:
          warningActionButtonColor ?? this.warningActionButtonColor,
      ...
      tabBarUnselectedColor:
          tabBarUnselectedColor ?? this.tabBarUnselectedColor,
      ...
      drawerHeaderIconColor:
          drawerHeaderIconColor ?? this.drawerHeaderIconColor,
      webViewAppBarColor: webViewAppBarColor ?? this.webViewAppBarColor,
      webViewProgressIndicatorColor:
          webViewProgressIndicatorColor ?? this.webViewProgressIndicatorColor,
      secondaryNeutralButtonColor:
          secondaryNeutralButtonColor ?? this.secondaryNeutralButtonColor,
  ...
  HubThemeExtension lerp(ThemeExtension<HubThemeExtension>? other, double t) {
    ...
    return HubThemeExtension(
      ...
      appBarTextColor: Color.lerp(
        appBarTextColor,
        other.appBarTextColor,
        t,
      ),
      appBarIconColor: Color.lerp(
        appBarIconColor,
        other.appBarIconColor,
        t,
      ),
      drawerHeaderTextColor: Color.lerp(
        drawerHeaderTextColor,
        other.drawerHeaderTextColor,
        t,
      ),
      drawerHeaderIconColor: Color.lerp(
        drawerHeaderIconColor,
        other.drawerHeaderIconColor,
        t,
      ),
      ...
      webViewProgressIndicatorColor: Color.lerp(
        webViewProgressIndicatorColor,
        other.webViewProgressIndicatorColor,
        t,
      ),
      secondaryNeutralButtonColor: Color.lerp(
        secondaryNeutralButtonColor,
        other.secondaryNeutralButtonColor,
        t,
      ),
